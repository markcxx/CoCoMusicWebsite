...
const PlatformSelector: FC<PlatformSelectorProps> = ({ downloadUrls, loading }) => {
            ...
            <div
              ...
              <div>
                <div className="flex items-center justify-between gap-x-4">
                  <h3 className="text-lg leading-8 font-semibold text-gray-900">{platform.title}</h3>
                  <platform.icon className="h-8 w-8 text-[var(--theme-color)]" aria-hidden="true" />
                </div>
                <p className="mt-4 text-sm leading-6 text-gray-600">{platform.desc}</p>
