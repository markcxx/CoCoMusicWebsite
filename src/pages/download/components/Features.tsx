    ...
    <div className="bg-gray-50 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base leading-7 font-semibold text-[var(--theme-color)]">CoCoMusic</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            {t('download_page.features.title')}
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">{t('download_page.features.subtitle')}</p>
        </div>
            ...
            {features.map((feature) => (
              <div
                ...
                <dt className="flex items-center gap-x-3 text-base leading-7 font-semibold text-gray-900">
                  <feature.icon className="h-5 w-5 flex-none text-[var(--theme-color)]" aria-hidden="true" />
                  {feature.name}
                </dt>
