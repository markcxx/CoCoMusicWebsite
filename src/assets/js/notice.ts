...
export const fetchNotice = async (): Promise<NoticeResponse["data"] | null> => {
  try {
    const response = await fetch(
      "https://data1.cherry-ai.com:48443/items/notice",
      {
        method: "GET",
      },
    );
...
export const fetchTopNotice = async (): Promise<
  NoticeTopResponse["data"] | null
> => {
  try {
    const response = await fetch(
      "https://data1.cherry-ai.com:48443/items/notice_top",
      {
        method: "GET",
      },
    );
